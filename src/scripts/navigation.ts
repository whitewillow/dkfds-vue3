...
//    */
//   focusTrapInit (trapContainer: HTMLElement) {
...
//   static toggleNav (incActive: boolean | undefined) {
//     const { body } = document;
//     const active: boolean = typeof incActive !== 'boolean' ? !Navigation.isActive : incActive;
...
//         focusTrap = this.focusTrapInit(trapContainers[i]);
//       }
//     }
