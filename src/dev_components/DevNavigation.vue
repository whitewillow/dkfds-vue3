<template>
  ...
  <nav class="nav">
    <button
      ...
      <svg
        class="icon-svg"
        aria-hidden="true"><use xlink:href="#close"></use></svg>Luk
    </button>
          ...
          <li>
            <div class="overflow-menu overflow-menu--open-left">
              <button
                ...
                <svg
                  class="icon-svg"
                  aria-hidden="true"><use xlink:href="#arrow-drop-down"></use></svg>
              </button>
              <div
                class="overflow-menu-inner"
                id="headeroverflow2"
    ...
    <div class="navbar">
      <div class="navbar-inner container navbar-context-actions">
        <div class="nav-actions">
          <a
            href=""
            class="function-link"><svg
              class="icon-svg"
              aria-hidden="true"><use xlink:href="#print"></use></svg>Funktionsikon</a>
          <a
            href=""
            class="function-link"><svg
            class="icon-svg"
            aria-hidden="true"><use xlink:href="#save"></use></svg>Funktionsikon</a>
        </div>
      </div>
    </div>
    ...
    <div class="solution-info-mobile">
      ...
      <p>
        ...
        <a
          ...
          class="icon-svg"
          aria-hidden="true"
          focusable="false"><use xlink:href="#open-in-new"></use></svg></a>
      </p>
    </div>
  </nav>
</template>
