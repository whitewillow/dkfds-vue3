    ...
    <div class="portal-header portal-header-compact">
      <div class="container portal-header-inner">
        ...
        <a
          ...
          class="logo"><span class="d-none d-print-block">
            Portalnavn
          </span></a>
        <!-- Slut: Portallogo -->
          ...
          <p>
            ...
            <span class="d-print-none">·
              <a
                ...
                aria-hidden="true"
                focusable="false">
                <use xlink:href="#open-in-new"></use></svg></a></span>
          </p>
        </div>
      </div>
    </div>
      ...
      <div class="navbar navbar-primary">
        <div class="navbar-inner container">
          <ul class="nav-primary">
            <li
              role="none"
              :class="[{ current: isPartOfMenu('home') }]">
              <fds-nav-link
                ...
                <ul class="mt-0 nobullet-list">
                  ...
                  <li class="">
                    <a
                      ...
                      href="#">Eller måske er du interesseret i noget helt andet, som tager mange
                      linjer at
                      forklare<svg
                        class="icon-svg"
                        focusable="&gt;false"
              ...
              <div class="align-text-left">
                ...
                <ul class="mt-0 nobullet-list">
                  <li class="">
                    <a
                      href="#"
                      class="function-link icon-link">Tilgængelighedserklæring<svg
                      class="icon-svg"
                      focusable="&gt;false"
                      aria-hidden="true">
                      <use xlink:href="#open-in-new"></use></svg></a>
